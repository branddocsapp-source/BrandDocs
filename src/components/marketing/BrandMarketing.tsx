...
const documentCards = [
  {
    ...
    description:
      "Create professional, tax-compliant invoices with automated numbering and line-item tax calculations.",
  },
  {
    title: "Digital Visiting Card",
    icon: "card-outline",
    description:
      "Design interactive digital business cards with QR codes, social links, and one-tap contact save.",
  },
  {
    title: "Business Quotation",
    icon: "document-text-outline",
    description:
      "Draft polished, itemized cost estimates and sales quotations with terms & validity periods.",
  },
  {
    title: "Table Quotation",
    icon: "grid-outline",
    description:
      "Build clear, structured tabular quotations ideal for product catalogs and multi-item orders.",
  },
  {
    title: "Branded Letterhead",
    icon: "mail-outline",
    description:
      "Generate executive branded letterheads with company headers, footers, and official digital stamps.",
  },
  {
    title: "Payment Receipt",
    icon: "wallet-outline",
    description:
      "Issue instant payment receipts for cash, bank transfers, deposits, or advance payments.",
  },
  {
    title: "Document Scanner & OCR",
    icon: "scan-outline",
    description:
      "Scan paper receipts or vendor bills and automatically extract key fields for document creation.",
  },
] as const;
...
const featureCards = [
  {
    ...
    description:
      "Manage multiple business profiles, logos, tax IDs, and addresses under one workspace.",
  },
  {
    title: "Automated Sequential Numbering",
    icon: "list-outline",
    description:
      "Set customized prefix formats and automatic document sequence numbering.",
  },
  {
    title: "Cloud & Email Backup",
    icon: "cloud-upload-outline",
    description:
      "Sync your document data securely to Cloud Storage and receive scheduled email backups.",
  },
  {
    title: "Instant PDF & Share",
    icon: "arrow-down-circle-outline",
    description:
      "Export clean vector PDFs ready for printing or instant sharing via WhatsApp, Email, and Web links.",
  },
] as const;
    ...
    >
      {icon ? (
        <Ionicons
          ...
          size={18}
          color={
            isPrimary ? "#FFFFFF" : isSecondary ? theme.orangeDark : theme.ink
          }
          style={{ marginRight: 6 }}
        />
      ) : null}
    ...
    >
      <View
        style={[
          ...
          {
            paddingHorizontal: layout.tokens.headerPaddingHorizontal,
            minHeight: layout.tokens.headerMinHeight,
          },
        ]}
      >
        {useCompactNav ? (
        ...
        {useCompactNav ? (
          ...
          <>
            <View
              style={[styles.headerCenterNav, { gap: layout.tokens.navGap }]}
            >
              {navItems.map((item) => (
                <Pressable
                  accessibilityRole="link"
                ...
                >
                  <Text style={[styles.navText, { color: theme.ink }]}>
                    {item.label}
                  </Text>
                </Pressable>
              ))}
      ...
      >
        <View style={styles.drawerRoot}>
          ...
          >
            ...
            <ScrollView
              contentContainerStyle={styles.drawerLinks}
                      ...
                      styles.drawerLinkText,
                      {
                        color:
                          item.label === "Get Started Free"
                            ...
                            : theme.ink,
                        fontWeight:
                          item.label === "Get Started Free" ? "800" : "700",
                      },
                    ]}
                  >
                    {item.label}
      ...
      {!compact ? (
        <View style={[styles.headerLine, { backgroundColor: theme.line }]} />
      ) : null}
    </View>
  );
}
...
function SectionHeading({
  ...
  return (
    <View style={styles.sectionHeading}>
      {eyebrow ? (
        <Text style={[styles.eyebrowBadge, { color: theme.orangeDark }]}>
          {eyebrow}
        </Text>
      ) : null}
      <Text
        accessibilityRole="header"
        style={[styles.sectionTitle, { color: theme.ink }]}
      >
        {title}
      </Text>
      {body ? (
...
function OutlineIcon({ name }: { name: string }) {
  ...
  return (
    <View
      style={[
        styles.outlineIcon,
        { backgroundColor: theme.orangeSoft, borderColor: theme.line },
      ]}
    >
  ...
  return (
    <View
      style={[
        ...
        compact && styles.playgroundShellCompact,
      ]}
    >
      {/* Top Tab Switcher */}
        ...
        {activeTab === "invoice" && (
          <View style={styles.docCanvas}>
            <View style={styles.docTopRow}>
              <View>
                <Text style={[styles.docBrandName, { color: theme.ink }]}>
                  NEXUS CREATIVE LABS
                </Text>
                <Text style={[styles.docSubtext, { color: theme.muted }]}>
              ...
              >
                <Text
                  style={[styles.docBadgeText, { color: theme.orangeDark }]}
                >
                  TAX INVOICE
                </Text>
                <Text style={[styles.docNumText, { color: theme.ink }]}>
                  #INV-2026-1048
                </Text>
              </View>
            </View>
            ...
            <View
              style={[styles.docDivider, { backgroundColor: theme.line }]}
            />

            <View style={styles.docMetaRow}>
              <View>
                <Text style={[styles.docMetaLabel, { color: theme.muted }]}>
                  BILLED TO:
                </Text>
                <Text style={[styles.docMetaValue, { color: theme.ink }]}>
            ...
            <View style={[styles.docTable, { borderColor: theme.line }]}>
              ...
              >
                <Text
                  style={[
                    styles.docTableCellHeader,
                    { color: theme.muted, flex: 2 },
                  ]}
                >
                  DESCRIPTION
                </Text>
                <Text
                  style={[styles.docTableCellHeader, { color: theme.muted }]}
                >
                  QTY
                </Text>
                <Text
              ...
              <View
                style={[styles.docTableRow, { borderBottomColor: theme.line }]}
              >
                <Text
                  style={[styles.docTableCell, { color: theme.ink, flex: 2 }]}
                >
                  Brand Identity & Digital Assets
                </Text>
                <Text style={[styles.docTableCell, { color: theme.ink }]}>
                  1
                </Text>
                <Text style={[styles.docTableCell, { color: theme.ink }]}>
                  $1,200.00
            ...
            <View style={styles.docTotalBlock}>
              <View style={styles.docTotalRow}>
                <Text style={[styles.docTotalLabel, { color: theme.muted }]}>
                  Subtotal:
                </Text>
                <Text style={[styles.docTotalValue, { color: theme.ink }]}>
                  $2,000.00
                </Text>
              </View>
              <View style={styles.docTotalRow}>
              ...
              >
                <Text style={[styles.docGrandTotalLabel, { color: theme.ink }]}>
                  Total Amount Due:
                </Text>
                <Text
                  style={[
                    styles.docGrandTotalValue,
        ...
        {activeTab === "visiting_card" && (
          <View style={styles.visitingCardCanvas}>
            <View style={styles.vCardHeader}>
              ...
              <View>
                <Text style={[styles.vCardName, { color: theme.ink }]}>
                  Alex Mercer
                </Text>
                <Text style={[styles.vCardRole, { color: theme.orangeDark }]}>
                  Founder & Creative Director
                </Text>
                <Text style={[styles.vCardCompany, { color: theme.muted }]}>
            ...
            <View style={styles.vCardContactGrid}>
              <View style={styles.vCardContactItem}>
                <Ionicons
                  ...
                  color={theme.orangeDark}
                />
                <Text style={[styles.vCardContactText, { color: theme.text }]}>
                  +1 (555) 234-5678
                </Text>
              </View>
              <View style={styles.vCardContactItem}>
            ...
            <View style={[styles.vCardFooter, { backgroundColor: theme.card }]}>
              ...
              <View style={{ flex: 1, marginLeft: 12 }}>
                ...
                <Text style={[styles.qrSubtitle, { color: theme.muted }]}>
                  Instant vCard & Digital Profile
                </Text>
              </View>
            </View>
          </View>
        ...
        {activeTab === "quotation" && (
          <View style={styles.docCanvas}>
            ...
            <View
              style={[
                styles.docTable,
                { marginTop: 12, borderColor: theme.line },
              ]}
            >
              <View
                style={[styles.docTableRow, { borderBottomColor: theme.line }]}
            ...
            <View style={styles.docTotalBlock}>
              <Text
                style={[styles.docGrandTotalValue, { color: theme.orangeDark }]}
              >
        ...
        {activeTab === "letterhead" && (
          <View style={styles.docCanvas}>
            ...
            >
              ...
              >
                BRANDDOCS GLOBAL SOLUTIONS
              </Text>
              <Text style={[styles.docSubtext, { color: theme.muted }]}>
                100 Innovation Parkway, Suite 400 • New York, NY
              </Text>
            </View>
            ...
            <Text style={{ fontSize: 13, color: theme.text, lineHeight: 20 }}>
              This letter serves as formal authorization and verification for
              company documentation standards under BrandDocs governance
              protocols.
            </Text>
            <View
              style={{
            ...
            >
              <View>
                <Text
                  style={{ fontSize: 13, fontWeight: "800", color: theme.ink }}
                >
              ...
              <View
                style={[styles.stampMock, { borderColor: theme.orangeDark }]}
              >
                <Text style={[styles.stampText, { color: theme.orangeDark }]}>
                  VERIFIED
                </Text>
              </View>
            </View>
        ...
        {activeTab === "receipt" && (
          <View style={styles.docCanvas}>
            <View style={styles.docTopRow}>
              ...
              <View
                style={[
                  styles.docBadge,
                  {
                    backgroundColor: isDark ? "#122A1E" : "#E6F7ED",
                    borderColor: isDark ? "#1E4D34" : "#A8E5BC",
                  },
                ]}
              >
                <Text
            ...
            >
              ...
              <Text
                style={{ fontSize: 26, fontWeight: "900", color: theme.ink }}
              >
                $1,450.00
              </Text>
...
function PricingSelector({
  ...
  return (
    <View
      style={[
        styles.pricingSelector,
        { backgroundColor: theme.wash, borderColor: theme.line },
      ]}
      accessibilityLabel="Country and currency selector"
    >
...
function PricingSection() {
  ...
  const [selectedCountry, setSelectedCountry] =
    useState<PricingCountryCode>(initialCountry);
  const { theme } = useAppTheme();
    ...
    <View style={styles.pricingWrap}>
      ...
      <View style={styles.pricingGrid}>
        ...
        >
          ...
          <Text style={[styles.planSubtext, { color: theme.muted }]}>
            Start creating approved BrandDocs documents.
          </Text>
            ...
            {freePlanItems.map((item) => (
              <View key={item} style={styles.planItem}>
                <Ionicons
                  ...
                  color={theme.orangeDark}
                />
                <Text style={[styles.planItemText, { color: theme.text }]}>
                  {item}
                </Text>
              </View>
            ))}
        ...
        <View
          style={[
            styles.planCard,
            isMobile && { width: "100%" },
            { backgroundColor: theme.white, borderColor: theme.orangeDark },
          ]}
        >
          <View
            style={[styles.popularBadge, { backgroundColor: theme.orange }]}
          >
            <Text style={styles.popularBadgeText}>MOST POPULAR</Text>
          </View>
          <Text style={[styles.planName, { color: theme.ink }]}>Premium</Text>
          <Text style={[styles.planPrice, { color: theme.ink }]}>
            {premiumPrice}
          </Text>
          <Text style={[styles.planSubtext, { color: theme.muted }]}>
            {premiumPricing.approved
              ? "per month"
              : "Final price for this region has not been approved yet."}
          </Text>
          <View style={styles.planItems}>
      ...
      >
        ...
        <View style={styles.billingCopy}>
          <Text style={[styles.billingTitle, { color: theme.ink }]}>
            Subscription & Cancellation
          </Text>
          <Text style={[styles.billingText, { color: theme.muted }]}>
            Your Premium subscription renews automatically each month unless you
            cancel it before the next renewal date. If you cancel, Premium
            access will continue until the end of your current paid billing
            period. Payments already made are non-refundable, including unused
            or partially used time.
          </Text>
          <Pressable
            accessibilityRole="link"
            onPress={() => goToRoute("/subscription-cancellation")}
            style={styles.billingLinkWrap}
          >
            <Text style={[styles.billingLink, { color: theme.orangeDark }]}>
        ...
        return (
          ...
          >
            <View style={styles.faqHeader}>
              <Text style={[styles.faqQuestion, { color: theme.ink }]}>
                {item.q}
              </Text>
              <Ionicons
...
function MailLink({ label, email }: { label: string; email: string }) {
  ...
  return (
    ...
    >
      ...
      <Text style={[styles.contactEmail, { color: theme.orangeDark }]}>
        {email}
      </Text>
    </Pressable>
  );
      ...
      >
        ...
        >
          <View style={styles.heroCopy}>
            ...
            >
              ...
              <Text style={[styles.badgeText, { color: theme.orangeDark }]}>
                #1 ALL-IN-ONE BUSINESS DOCUMENT PLATFORM
              </Text>
            </View>
            ...
            <Text style={[styles.heroText, { color: theme.muted }]}>
              Create tax invoices, digital business cards, quotations,
              letterheads, and payment receipts in seconds. Cloud-backed,
              instant PDF export, and tax-compliant.
            </Text>
            ...
            <View style={styles.heroHighlights}>
              {[
                ...
                >
                  ...
                  />
                  <Text
                    style={[styles.heroHighlightText, { color: theme.text }]}
                  >
                    {item}
                  </Text>
                </View>
        ...
        >
          <View style={styles.metricItem}>
            <Text style={[styles.metricNumber, { color: theme.ink }]}>
              10,000+
            </Text>
          ...
          {!isMobile ? (
            <View
              style={[styles.metricDivider, { backgroundColor: theme.line }]}
            />
          ) : null}
          <View style={styles.metricItem}>
            <Text style={[styles.metricNumber, { color: theme.ink }]}>
        ...
        <View
          onLayout={(event) =>
            setSectionPosition("documents", event.nativeEvent.layout.y)
          }
          style={[
            layout.container,
            styles.section,
            { paddingVertical: layout.tokens.sectionPaddingVertical },
          ]}
        >
          <SectionHeading
        ...
        <View
          onLayout={(event) =>
            setSectionPosition("features", event.nativeEvent.layout.y)
          }
        ...
        <View
          onLayout={(event) =>
            setSectionPosition("pricing", event.nativeEvent.layout.y)
          }
          style={[
            layout.container,
            styles.section,
        ...
        <View
          onLayout={(event) =>
            setSectionPosition("faq", event.nativeEvent.layout.y)
          }
          style={[styles.sectionBand, { backgroundColor: theme.wash }]}
        >
          <View
        ...
        <View
          onLayout={(event) =>
            setSectionPosition("about", event.nativeEvent.layout.y)
          }
          style={[
            layout.container,
            styles.section,
        ...
        >
          <View style={styles.aboutGrid}>
            ...
            >
              <Text
                accessibilityRole="header"
                style={[styles.sectionTitleLeft, { color: theme.ink }]}
              >
                About BrandDocs
              </Text>
              <Text style={[styles.aboutText, { color: theme.text }]}>
                BrandDocs empowers entrepreneurs, freelancers, and businesses to
                generate clean, consistent, and professional business documents
                with speed and brand integrity.
              </Text>
            </View>
            <View
              style={[
            ...
            >
              <MailLink
                ...
                email="branddocs.app@gmail.com"
              />
              <MailLink
                label="Customer Support"
                email="branddocs.support@gmail.com"
              />
              <View style={[styles.noReplyBox, { borderColor: theme.line }]}>
                ...
                <Text style={[styles.noReplyEmail, { color: theme.text }]}>
                  branddocs.noreply@gmail.com
                </Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.featureGrid}>
            {items.map((item) => (
              ...
              >
                ...
                <Text style={[styles.cardText, { color: theme.muted }]}>
                  Dedicated assistance and guidance for {item.toLowerCase()} in
                  your BrandDocs workspace.
                </Text>
              </View>
            ))}
          </View>
  ...
  return (
    <View
      style={[
        ...
        { backgroundColor: theme.white, borderTopColor: theme.line },
      ]}
    >
      <View style={[layout.container, styles.footerInner]}>
        ...
        <View style={styles.footerColumns}>
          ...
          <View style={styles.footerBrandCol}>
            ...
            <Text style={[styles.footerTagline, { color: theme.muted }]}>
              The all-in-one business document & digital branding workspace.
              Designed for speed, precision, and compliance.
            </Text>
            ...
            >
              <View
                style={[
                  styles.statusDot,
                  { backgroundColor: isDark ? "#43D888" : "#1E824C" },
                ]}
              />
              <Text
                style={[
            ...
            >
              ...
              />
              <Text
                style={[styles.securityBadgeText, { color: theme.orangeDark }]}
              >
                256-bit SSL • Bank-Grade Encrypted
              </Text>
            </View>
          </View>
          ...
          <View style={styles.footerCol}>
            <Text style={[styles.footerColTitle, { color: theme.ink }]}>
              Document Tools
            </Text>
        ...
        <View style={[styles.footerBottomBar, { borderTopColor: theme.line }]}>
          <Text style={[styles.copyrightText, { color: theme.muted }]}>
            Copyright © 2026 BrandDocs. All rights reserved. Built for modern
